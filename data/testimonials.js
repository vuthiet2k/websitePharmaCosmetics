...
const testimonials = [
  {
    ...
    quote: 'Sau 6 tuần theo phác đồ B5 + Ceramide, da mình giảm hẳn đỏ rát và không còn nổi mụn mới. Bác sĩ theo sát từng tuần rất yên tâm.',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Nám sau sinh của mình mờ hẳn sau 3 tháng kiên trì theo đúng lộ trình bác sĩ đưa ra, không cần laser xâm lấn.',
    rating: 5,
